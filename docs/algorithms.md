...
- NaN in training: likely caused by updating alpha on every transition instead of once per batch. The plugin has a fix for this — see [feedback_sac_alpha_nan.md](../memory/feedback_sac_alpha_nan.md).
